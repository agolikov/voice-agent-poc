...
export const GlobalControls = () => {
  ...
  // The access gate is the one page whose visitor cannot follow this link: it
  // would bounce straight back here. The language switcher stays, because the
  // gate has copy of its own to read.
  const locked = usePathname() === "/unlock";
  return (
